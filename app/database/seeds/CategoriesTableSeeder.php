...
'
			...
			[
				'name'=>'Arachnids', 
				'slug'=>'arachnids',
				'description'=>'Though technically [spiders](/Animals/spiders) should be in this group, they’ve been given their own separate category. So the only truly bad thing left is the Paralysis Tick, a species which is so common it has killed 20 people so far, and probably a takes out a pet almost every day.'
			],
			[
				'name'=>'Insects', 
				'slug'=>'insects',
