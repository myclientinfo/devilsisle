...
class AnimalsTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		$animals = array(
                    ...
                    'description' => 'The Sydney Funnel-web is found around Sydney, Australia, which makes it the 4,627,346th most obnoxious cunt in the general area. The Sydney Funnel Web is one of the few spiders that could be realistically considered dangerous, but as the Brazilian Wandering Spider has venom that can break your dick, the Funnel Web comes in a close second.
...
Funnel Webs are old school spiders. It’s a “mygalomorph”, meaning it’s a bit less evolved than your fancy pants modern spiders. Its huge fangs point straight down, which is why it has rear up terrifyingly in order to strike down. Those fangs can pierce a shoe.
...
'description' => 'The northern oceans of Australia are home to a bastard on a level few other creatures could match or would want to. The Adolf Hitler of the seas.
...
The burning of a Box Jellyfish sting is sheer screaming agony, and the tentacles will stick and wrap around. The danger of the sting basically comes down to how much contact the tentacles made. A single short tentacle on a leg is not too big a deal. All the tentacles from a large one wrapped around the body? That’s a bad time. Thankfully not a long time - death can occur within a few minutes, and the victim sometimes has a heart attack before being able to get to shore. So that’s a plus.

The first treatment is salad dressing. Vinegar is poured on the tentacles to stop them stinging, then they’re carefully pulled off with a gloved hand or tweezers. There is an antivenom that can help if an ambulance can get to the patient. But the remainder of the treatment is basically a series of valiant medical team fending off the grim reaper as the patient repeatedly dies.

In early 2000 a 17 year old Australian boy decided to drink a glass of water from the fridge at his local surf lifesaving club. What he didn’t realise was that there was a box jellyfish in the water. In the fridge. He swallowed it, or at the very least a part of it. I can’t find the reports to back this up, but from memory he died 18 times. He’s fine now, except for the permanent scarring in his throat.

The Box Jellyfish has other names. It’s referred to in some places as the “Sea Wasp”, or worse still, “Marine Stingers” which is a bit like calling Jeffrey Dahmer “that naughty boy”.  Swimmers and surfers in Northern Australia wear pantyhose, which surprisingly effective at stopping the venom cells firing off. Even among the most conservative people in the country, cross dressing is totally acceptable compared to an agonising death.

Box Jellyfish are known to have killed more than 60 people in Australia. That’s over a pretty long time, though, one every two years or so. Barely a problem.',
					'short_description'=>'',
					'appearance'=>'6',
					'danger'=>'10',
					'risk'=>'8',
					...
					'description'=>'The [Box Jellyfish](/Animals/jellyfish/box-jellyfish) is a complete asshole, but even that looks like fucking kitten compared to the Irukandji. There are a lot fewer deaths from Irukandji than Box Jellyfish, only two confirmed compared to more than 60.
...
The agony of being stung by these hellspawn lasts for more than a day. Symptoms can linger for weeks.

A lot of our knowledge of Irukanji venom comes from a number of researchers who were stung by Irukanji on purpose. This includes Jack Barnes, who first confirmed this monster was the cause of the syndrome by putting one on his arm. This walks a fine line between inspirational courage and the sort of person who has to walk around with a bicycle helmet on at all times. I assume as soon as he did it he yelled to the camera “and this is Jackass”. The species is now either named after him or classic Australian blue collar rocker Jimmy Barnes.',
					'short_description'=>'',
					'appearance'=>'6',
					'danger'=>'9',
					'risk'=>'8',
...
These spiders don’t do themselves any favours. There are photos of them on the internet, confirmed pictures of them eating small birds they’ve caught, or even in some cases small snakes. There is no excuse for that sort of shit.

The other major problem with them is their webs. Nephlia spiders make very large webs. These sometimes stretch between buildings, and deciding to block a walking path is not uncommon. The webs are impressively strong to the point of being hard for even a human to walk through, and the knowledge that there’s likely to be a giant spindley arachnid of terror in there really puts a cherry on the top of the horror cake.
...
The temptation to say that they were hungry again 20 minutes later has been a difficult challenge.
...
Of course, the boys didn’t just “run across it”. They heard it was there, and decided to get some sticks and beat it to death. So frankly, fuck them, I’m glad he died.
...
And definitely don’t try to cook them. Cassowary recipes say to include a small piece of stone in with the bird. When the rock is soft, the cassowary should be, too.

Because humans are assholes they’re running out of places to live and tend to get hit by cars a lot. As a result cassowaries are endangered. A recent cyclone in their home range killed as many as 10% of the remaining population.',
					'short_description'=>'',
					'appearance'=>'3',
					'danger'=>'4',
					'risk'=>'4',
...
But the Brown Snake is common. The best known species, the Eastern Brown Snake is also called the Common Brown Snake. They’re not callled that because they’re rare. And its venom is incredibly potent. When the late, great Steve Irwin did a special on the most deadly snakes in the world, for eight of them he didn’t have to leave the country. And one of them, the Brown Snake, he didn’t have to leave the house - he got a call from his wife because there was one in the garage.

Brown Snakes live where people live. They’re encountered quite often, and as a result they’re responsible for more fatalities than any other group of snakes. It should be noted that like most dangerous animals, 75% of bites are caused by people trying to catch them or kill them. So if you leave them alone you can be in the lucky 25% that just got shat on by life.
...
Even with the low odds, the use of antivenom and excellent medical treatment, there are still one or two people who die from Brown Snake bites every year.',
					'short_description'=>'',
					'appearance'=>'7',
					'danger'=>'10',
					'risk'=>'9',
...
The venom it injects is insane. The venom is potent enough that the amount injected in a single bite could kill more than 100 full-grown men. That’s twice as many as a Black Mamba, and with a quarter of the amount of venom injected. It’s 30 times more than a King Cobra, which injects **nine times** the venom.

There is one advantage humanity has against the horrifying threat of the Inland Taipan. They live inland. Australia is pretty much a desert ringed with habitable cost, and the Inland Taipan lives in places humans wouldn’t want to. It’s a remote habitat, and they’re never encountered by humans. Unlike the [Coastal Taipan](/Animals/snakes/coastal-taipan), which is an absolute cunt famous for chasing people just to bite them, the Inland Taipan is shy and timid.
...
All ticks inject a cocktail of weird shit into their host. It’s a mix of stuff to stop blood clotting, but also to stop the host feeling pain, or swelling, etc. Paralysis Ticks just have one extra ingredient - a paralytic neurotoxin.

This venom is not fast-acting. Right at the start the tick doesn’t inject any venom at all, or only a tiny bit. At the earliest only two days in, but after up to a week, the legs weaken. The weakness travels up the body until fully paralysing the victim finishing off with the lungs. Venom can continue acting on the body for up to four days, so getting the fucker gone is important. They’re basically hanging there drinking from a pit made into your skin so they can fill up with tasty blood and make a billion babies. So you really don’t want them there.
...
That email and Facebook thing about them coming off if you put vaseline or some sort of cream on them is complete horse shit. Ticks barely need to breathe, and won’t asphyxiate. Pull them out from the head with tweezers. Now. Immediately. They are actively killing you.
...
Most stings from platypus occured when it was still legal to hunt them for their fur, so fuck those guys. Occasionally fishermen accidentally catch them and risk a savage spikening.
...
The Redback is very closely related to the US Black Widow Spider, and their bites are approximately the same in effect. Generally a shitty time is had by all. The bite results in nausea, vomiting, sweating, headaches and occasionally coma and death. Depending on the size of the person bitten, death can take anywhere from a few hours to a month. A horrible, horrible month.
...
And they’re spreading. They’ve been found in New Zealand and even the UK, probably brought in on ships. There’s a permanent population in Osaka, Japan now, a country that has never had a venomous spider before.
...
Cone shells are sometimes jokingly referred to as “Cigarette Snails”. Because if one stings you, you’ll have time to smoke a cigarette before you die. Hilarious.
...
A decent sized one can can be bigger than an outstretched hand. Approximately the correct size to sit right across your entire face. Just so you know.
...
Sort of. Really all spiders are venomous, with a few irrelevant exceptions, but only rarely does a spider’s venom have much effect on humans. These are insect neurotoxins, so they’re not really built for large smelly apes. 
...
They’re not only harmless, they’re beneficial. Hunstman Spiders kill a lot of other nasties, like cockroaches and less pleasant spiders. Whether it’s caused by an ancestral fear or a new superstition, the vast majority of spiders, including the Huntsman are harmless. They are feared unjustly and pay for it with their lives. They’re not in any way capable of harming a human.
...
Giant Water Bugs are a common food in Thailand, where they’re sold deep fried from small carts on many streets. Locals report they taste not unlike spicy shrimp or prawns. Locals are lying. They taste like someone took a shit in your mouth, only crunchy. They’re also used powdered as a spice, apparently tasting like coriander (better known as cilantro in the US). 

Giant Water Bugs are easy to confuse with the unrelated Water Scorpion. They look almost exactly the same, except for the long spike coming from the rear of the water scorpion.',
					'short_description'=>'',
					'appearance'=>'10',
					'danger'=>'2',
					'risk'=>'3',
...
Actually… I’m going to be honest, it’s hard to say much more about these things other than holy shit they look scary. But at some point it has to be admitted. These are utterly harmless in every way possible. They actually make good pets, and are a growing trade in the US. They have strong family bonds. A mother will raise her babies, carrying them with her until they molt for a second time. If they are distressed, the mother will stroke them to calm them. Siblings that are separated will cuddle close when they are put back together.

If you didn’t know I was talking about a predatory arachnid right now, I could be describing kittens. These are kittens. If there was any justice you’d see them on really crappy Valentines Day cards, with bows on them, or in a little basket. Actually, considering a kitten will happily bite and scratch like a demon, and an Amblypygi almost never will, a kitten is actually significantly more dangerous.
...
The Red Bellied Black snake is one of Australia’s worst venomous snakes. I don’t mean they’re the most dangerous. I mean the opposite. Australians usually think these are dangerous snakes. They are not. They are completely rubbish at being venomous.
...
At this point, the Red-bellied Black is so unaggressive that it will rarely bite, even if picked up or if stepped on. If they do by some miracle get up enough savage serpentine fury to actually bite, they’re so unaggressive that they often bite **with their mouth closed**. This is the most shitty strike any snake can possibly make. That’s not even trying. It’s almost insulting. That’s not a bite, it’s like a nudge, or a poke. You can’t just *boop* people. Jesus Christ, snake, this is embarrassing.
...
The Red Kangaroo isn’t the only kind of Kangaroo. The smaller Eastern Grey has a larger population and is more likely to be seen in habited areas. Smaller species are known as Wallabies, and are adorable, with softer features that look not unlike a possum.

Smaller kangaroo species can still kick powerfully, but their impact and danger diminishes with their size.

Kangaroos also have weird junk. The males of smaller species (not the Eastern Gray or Red Kangaroos) have a forked penis, which works out great because the female has three vaginas. There’s a common doorway, but then three paths. This setup, along with the two uteri, make the jill an impressive baby-making machine. She can have one joey in her pouch, a foetus on the boil and an egg ready and waiting for a strapping boomer to hop on by. Impressively, she can even hit pause on the feotus like a Tivo rerun, and stop its development until food is more available or she just feels like it.',
					'short_description'=>'',
					'appearance'=>'2',
					'danger'=>'2',
					'risk'=>'3',
...
Honeybees kill more people in Australia than any other animal. In fact, honeybees kill more people in Australia than [snakes](/Animals/snakes), [spiders](/Animals/spiders), centipedes, and [scorpions](/Animals/arachnids/scorpion) combined. (Admittedly those last three don’t kill anyone at all, so I’m cheating a bit.)
...
That said. Not one death has ever been reported from an Australian species of Scorpion. They are just not that dangerous. Painful, but not dangerous. Stings should be be checked by a doctor, just to be sure. But while an Australian scorpion is a guaranteed poor choice for the prize in a game of pass-the-parcel it’s hardly the stealthy death dealer people seem to think it is.
...
There is a choice Scorpions make, evolutionarily speaking. Am I going to be strong, with powerful tearing claws, or am I going to be small and uninspiring, but deadly as fuck? The bigger, heavier scorpions look more concerning. But it’s actually the little ones you have to watch out for. All the genuinely deadly ones are reasonably small, and lack the massive hulking claws many associate with scorpions.',
					'short_description'=>'',
					'appearance'=>'8',
					'danger'=>'3',
					'risk'=>'2',
